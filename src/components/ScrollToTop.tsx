    ...
    <AnimatePresence>
      {isVisible && !isBlocked && (
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-[80] p-3 md:p-4 bg-primary text-black rounded-full shadow-2xl cursor-pointer transition-colors"
