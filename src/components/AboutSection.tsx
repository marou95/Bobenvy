            ...
            <div className="lg:col-span-4 flex flex-col gap-2">
                {TABS.map((tab, index) => (
                    <button
                        ...
                        className={`text-left py-6 px-6 border-b border-light-border/20 dark:border-dark-border/20 transition-all duration-300 group relative overflow-hidden rounded-lg ${
                            activeTab === index 
                    ...
                    >
                        ...
                        <span className={`font-mono text-[10px] uppercase tracking-widest mb-1 block transition-colors ${
                            activeTab === index ? 'text-primary' : 'text-light-muted dark:text-dark-muted'
                        }`}>0{index + 1}</span>
                        
                        <span className={`font-museo text-2xl transition-colors ${
                            activeTab === index ? 'text-light-text dark:text-dark-text' : 'text-light-muted dark:text-dark-muted opacity-50 group-hover:opacity-100'
                        }`}>
                            {tab.label}
                        </span>
                    </button>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="mt-12 pt-8 border-t border-light-border/20 dark:border-dark-border/20 flex gap-6">
                                <Link to="/contact" className="group flex items-center gap-2 text-sm font-bold uppercase tracking-widest hover:text-primary transition-colors">
                                    Discuter avec nous <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform"/>
                                </Link>
                                <button className="text-sm font-mono opacity-50 hover:opacity-100 transition-opacity">
                                    En voir plus
                                </button>
                            </div>
                        </div>
