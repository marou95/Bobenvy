                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <a href="https://www.facebook.com/profile.php?id=61576514106429" target="_blank" rel="noreferrer" className="p-2 border border-light-border dark:border-dark-border rounded-full hover:border-primary hover:text-primary transition-colors">
                          <Facebook size={18} />
                      </a>
                    </div>
                  </div>
